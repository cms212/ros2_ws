...
#ifndef ROBOT__MSG__DETAIL__ARM_POSITION__FUNCTIONS_H_
#define ROBOT__MSG__DETAIL__ARM_POSITION__FUNCTIONS_H_
 ...
 * )) before or use
 * robot__msg__ArmPosition__create()
 ...
 * robot__msg__ArmPosition__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robot__msg__ArmPosition__Sequence__fini()
 * on the array,
...
#endif  // ROBOT__MSG__DETAIL__ARM_POSITION__FUNCTIONS_H_
